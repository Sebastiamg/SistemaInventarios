    ...
    <div className='border-3 border-slate-500 rounded-xl mx-5 my-4 shadow-md shadow-slate-600'>
      ...
      <div>
          <div className='w-full flex justify-end font-semibold'>
            ...
            <button className='mx-3 border-2 border-slate-600 p-1 rounded-md bg-slate-500 hover:bg-slate-600 text-slate-50' onClick={() => showModalInsert()}>Add Expense</button>
            <button className='mx-3 border-2 border-slate-600 p-1 rounded-md bg-slate-500 hover:bg-slate-600 text-slate-50'>
              <ReactHTMLTableToExcel id="botonExportarExcel" className="bottom-4" table="expenses" filename="expensesExcel" sheet="Expenses" buttonText="Export Expenses" />
              <div id='tableExport'>
          ...
          <ModalBody >
            ...
            <FormGroup>
              ...
              <select class="select outline-blue-500 w-full border-2 p-1 border-slate-400 rounded-md" name="responsible" onChange={handleChange} value={form.responsible}>
                {datas.map( (datou) => ( 
                  <option key={datou.id} value={datou.name}>{datou.name}</option>
                ))}
              </select>
            </FormGroup>
            <FormGroup>
