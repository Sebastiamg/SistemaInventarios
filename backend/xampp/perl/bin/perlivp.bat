...
#!perl
#line 29
    eval 'exec \Users\steve\OneDrive\Escritorio\pruebas proyecto\mgmnt\backend\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = '\Users\steve\OneDrive\Escritorio\pruebas proyecto\mgmnt\backend\xampp\perl\bin\perl.exe';
