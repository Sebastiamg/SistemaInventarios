...
#!perl
#line 29
    eval 'exec \Users\HP\Desktop\PROYECTOS\SistemaInventarios\backend\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = '\Users\HP\Desktop\PROYECTOS\SistemaInventarios\backend\xampp\perl\bin\perl.exe';
