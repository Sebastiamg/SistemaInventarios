  ...
  <div class=\"item\" id=\"authentication_plugin_div\">
    ...
    <div id=\"ssl_reqd_warning\"";
      ...
      ";
        ...
        echo "
      ";
        $___internal_30be61938f4a4517c75a16f4eb8244a6d83ca6740ded4b1868a6ce2b042699e0_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 82
        echo call_user_func_array($this->env->getFilter('notice')->getCallable(), [$___internal_30be61938f4a4517c75a16f4eb8244a6d83ca6740ded4b1868a6ce2b042699e0_]);
        // line 88
        echo "    </div>
  </div>
  ";
...
";
    ...
    {
        return new Source("", "server/privileges/login_information_fields.twig", "C:\\Users\\steve\\OneDrive\\Escritorio\\proyecto\\mgmnt\\backend\\xampp\\phpMyAdmin\\templates\\server\\privileges\\login_information_fields.twig");
    }
}
