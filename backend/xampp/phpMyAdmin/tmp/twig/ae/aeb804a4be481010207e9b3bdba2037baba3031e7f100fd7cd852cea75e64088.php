...
class __TwigTemplate_01421a9380ba0f6eff642090cd0710a19b5555444cff11b106e5d545f4f4cb9a extends \Twig\Template
{
  ...
  ";
        ...
        if ( !($context["has_config_storage"] ?? null)) {
            ...
            // line 61
            echo "    ";
            $___internal_8d8e6e6da97638560a5849839459f2cc90ce9856acd0ba2e0eec1c73064c323b_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
            // line 59
            echo call_user_func_array($this->env->getFilter('notice')->getCallable(), [sprintf($___internal_8d8e6e6da97638560a5849839459f2cc90ce9856acd0ba2e0eec1c73064c323b_, (("<a href=\"" . \PhpMyAdmin\Html\MySQLDocumentation::getDocumentationLink("setup", "linked-tables")) . "\" target=\"_blank\" rel=\"noopener noreferrer\">"), "</a>")]);
            // line 62
            echo "  ";
        }
    }
    ...
    {
        return new Source("", "preferences/header.twig", "C:\\Users\\steve\\OneDrive\\Escritorio\\pruebas proyecto\\mgmnt\\backend\\xampp\\phpMyAdmin\\templates\\preferences\\header.twig");
    }
}
